...
export default function HomePage({
	...
	return (
		<>
			...
			<MainLayout mainBackgroundImg='/assets/images/BFL_Wallpaper.jpg'>
				<Container>
					<div className={styles.landing}>
						<span className={styles.subtitle}>Bienvenue sur</span>
						<h1 className={styles.title}>
							The Brawlers <span className='red'>French</span>{' '}
							<br />
							<span className='red'>Lobby</span>
						</h1>
					...
					{/* <div className={styles.mainLogo}>
							<Image
								src='/assets/images/BFL_LOGO_TEXT.png'
								width={360}
								height={240}
							/>
						</div> */}
